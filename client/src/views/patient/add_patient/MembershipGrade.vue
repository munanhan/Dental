        ...
        >
            ...
            <div class="content">
                    ...
                    >
                        ...
                        <el-table-column
                                v-for="(item) in member_menu.columns"
                                :prop="item.field"
                                :label="item.title"
                        >
                            <template slot-scope="scope">
                            <span v-if="scope.row.isSet">
                                <el-input size="mini" placeholder="请输入内容" v-model="member_menu.sel[item.field]">
                                </el-input>
                            </span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            cancel(row,index){
                let that=this;
                if (!that.member_menu.sel.id) that.member_menu.data.splice(index, 1);
                row.isSet = false;
            },
