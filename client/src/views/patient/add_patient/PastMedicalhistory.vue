                    ...
                    >
                        <template slot-scope="scope">
                            <span v-if="scope.row.isSet">
                                <el-input size="mini" placeholder="请输入内容" v-model="anamnesis_menu.sel[item.field]">
                                </el-input>
                            </span>
...
export default {
    ...
    methods: {
        ...
        cancel(row,index){
            let that=this;
            if (!that.anamnesis_menu.sel.id) that.anamnesis_menu.data.splice(index, 1);
            row.isSet = false;
        },
