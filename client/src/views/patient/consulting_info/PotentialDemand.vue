<template>
    <div>
        ...
        <add-potential-demand :show.sync="addpotdem_show"></add-potential-demand>
...
import AddPotentialDemand from "./AddPotentialDemand";
