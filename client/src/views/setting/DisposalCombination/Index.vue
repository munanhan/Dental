<template>
    <div class="content" ref="menuContent">
      <el-container>
        <el-aside class="left" :style="{'width':255+'px'}">
        ...
        <el-main class="right">
          ...
          <el-row>
              <div class="btn_content">
                  <el-col :span="24">
                        <span class="">
                            <el-button type="primary" style="margin-right: 10px;" @click="showAddDialog">添加</el-button>
                        </span>
                  
                        <span class="">
                            <el-button type="primary" style="margin-right: 10px;" @click="importData">导入Excel</el-button>
                        </span>
                  
                        <span class="">
                            <el-button type="primary" style="margin-right: 10px;" @click="exportData">导出Excel</el-button>
                        </span>
                  </el-col>
              </div>
          </el-row>
