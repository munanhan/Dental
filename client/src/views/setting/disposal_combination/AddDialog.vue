<template>
  <div>
    <el-dialog
        ...
        <el-container>
          <el-header class="header" style="height: 37px;">
            <div class="title">处置选择</div>
          </el-header>
          <el-container>
            <el-aside style="height:600px;" class="aside">
              <el-row>
              ...
              <el-main class="main">
                <el-row>
                    <div class="search">
                      <el-col :span="8">
                            <span class="mr10">
                                <el-input v-model="search.disposal_name" placeholder="名字"></el-input>
                            </span>
                      </el-col>
                ...
                <el-row>
                  ...
                  <el-button style="margin: 5px" type="success" size="mini" @click="addSelectDesposal">↓ 添加</el-button> 
                  <el-button style="margin: 5px" type="warning" size="mini" @click="delSelectForm">↑ 删除</el-button>
                </el-row>
                <el-row>
                  <el-table
                        :data="form"
      ...
      methods: {
        ...
        delSelectForm(){
          ...
          if (Object.keys(this.select_form).length == 0) {
            ...
            // console.log(this.select_form);
            this.form = this.form.slice(0, this.select_form.index).concat(this.form.slice(parseInt(this.select_form.index, 10) + 1));
          }
        ...
        delDisposal(data,index){
          //删除处置
          console.log(index);
          this.form = this.form.slice(0, index).concat(this.form.slice(parseInt(index, 10) + 1));
          //删除元素
        },
        addDisposal(data){
          //添加处置
