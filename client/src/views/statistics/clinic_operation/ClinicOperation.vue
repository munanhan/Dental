<template>
  <div class="clinic">
    ...
    <div class="clinic-content" ref="content" @scroll="notifyScroll">
      <div class="clinic-left">
        <!-- <div class="clinic-item">

        </div>-->

        <div class="clinic-item clearfix" ref="_1">
          <div class="pull-right">
            期初欠数：
            <span class="tip">20.10</span>
          </div>
          <el-table
            :data="tableData"
            border
          ...
          >
            ...
            <el-table-column prop="date" label="应收款项" align="center"></el-table-column>

            <el-table-column prop="date" label="实际收款" align="center"></el-table-column>

            <el-table-column prop="date" label="新增次数" align="center"></el-table-column>

            <el-table-column prop="date" label="补收欠款" align="center"></el-table-column>

            <el-table-column prop="date" label="预交数充值" align="center"></el-table-column>
          </el-table>
        ...
        <div class="clinic-item" ref="_2">
          <el-table
            ...
            show-summary
          >
            <el-table-column prop="date" label="主治医生" align="center"></el-table-column>

            <el-table-column prop="date" label="总诊人数" align="center"></el-table-column>

            <el-table-column prop="date" label="初诊人数" align="center"></el-table-column>

            <el-table-column prop="date" label="复诊人数" align="center"></el-table-column>

            <el-table-column prop="date" label="合计实收" align="center"></el-table-column>
          </el-table>
        </div>

        <div class="clinic-item" ref="_3">
          <div>
            <span class="chart-tip">&nbsp;</span>就诊人数
          </div>
          <ve-line :data="visitData" :settings="visitSettings"></ve-line>
        </div>

        <div class="clinic-item" ref="_4">
          <div>
            <span class="chart-tip">&nbsp;</span>营业收入
          </div>
          <ve-line :data="businessData" :settings="businessSettings"></ve-line>
        </div>

        <div class="clinic-item" ref="_5">
          <div>
            <span class="chart-tip">&nbsp;</span>患者来源收费统计
          </div>
          <ve-pie :data="patientCost"></ve-pie>
        </div>

        <div class="clinic-item" ref="_6">
          <div>
            <span class="chart-tip">&nbsp;</span>患者来源人数统计
          </div>
          <ve-pie :data="patientNum"></ve-pie>
        </div>

        <div class="clinic-item" ref="_7">
          <div>
            <span class="chart-tip">&nbsp;</span>收费分类统计
          </div>
          <ve-pie :data="classificationOfCharges"></ve-pie>
        </div>

        <div class="clinic-item" ref="_8">
          <div>
            <span class="chart-tip">&nbsp;</span>预约统计
          </div>
          <ve-line :data="bookData" :settings="bookSettings"></ve-line>
        </div>

        <div class="clinic-item" ref="_9">
          <div>
            <span class="chart-tip">&nbsp;</span>预约项目一览
          </div>
          <ve-histogram :data="bookProjectData" :settings="bookProjectSettings"></ve-histogram>
        </div>

        <div class="clinic-item" ref="_10">
          <div>
            <span class="chart-tip">&nbsp;</span>预约状态分析
          </div>
      ...
      <div class="clinic-right" @wheel.stop.prevent="cateScroll">
        <el-timeline>
          <el-timeline-item v-for="(activity, index) in activities" :key="index" color="#0bbd87">
            <div
...
export default {
  ...
  data() {
    return {
        ...
        shortcuts: [
          ...
          },
          {
            ...
            onClick(picker) {
              ...
              picker.$emit("pick", [curMonth.start, curMonth.end]);
            }
          }
        ]
      },
      ...
      reservation_status: {
        columns: ["type", "status"],
        rows: [{ type: "1/1", status: 1393 }, { type: "1/2", status: 3530 }]
      },
      //--------------------------------
  ...
  methods: {
    ...
    getData() {
      ...
      // 预约项目统计
      that.$api.appointment
        .clinicAppointItemData(that.search)
        .then(res => {
          if (res.code == 200) {
            that.bookProjectData.rows = res.data.data;
          } else {
            that.$message.error(res.msg || "获取数据失败，请重试.");
          }
      ...
      // 预约状态统计
      that.$api.appointment
        .clinicAppointStatusData(that.search)
        .then(res => {
          if (res.code == 200) {
            res.data.data.map(ele => {
              switch (ele.type) {
               ...
               that.reservation_status.rows = res.data.data
          } else {
            that.$message.error(res.msg || "获取数据失败，请重试.");
          }
